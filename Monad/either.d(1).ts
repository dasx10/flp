...
export declare const alt: <Next>(value: Next) => {
  <Value extends Right<any> | Just<any>>(value: Value) : Value;
  (value: Left<any>) : Right<Next>;
  <Value>(value: Either<Value, any> | PromiseLike<Value>) : RightOf<Next | Value>;
};

export declare const bimap:<Return, Value>(call: (value: Value) => Return) => {
  (value: Left<Value>): RightOf<Return>;
  <Next>(value: Either<Next, Value> | PromiseLike<Next>): RightOf<Return> | RightOf<Next>;
  <Resolved extends Right<any> | Just<any>>(value: Resolved): Resolved;
};
